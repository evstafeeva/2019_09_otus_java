...
public class DbExecutor<T> {
    ...
    public long insertRecord(Connection connection, String sql) throws SQLException {
...
//      }
    ...
    public long updateRecord(Connection connection, String sql, long id) throws SQLException{
        Savepoint savePoint = connection.setSavepoint("savePointName");
        try (PreparedStatement pst = connection.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS)) {
            pst.setLong(1, id);
            pst.executeUpdate();
